...
const UI_STRINGS = {
  fr: {
    ...
    errorEmailNotConfirmed: "Veuillez confirmer votre e-mail (lien reçu par courriel) avant de vous connecter.",
    errorGeneric: "Une erreur est survenue. Veuillez réessayer.",
    forgotPassword: "Mot de passe oublié ?",
    resetEmailSent: "E-mail de réinitialisation envoyé. Vérifiez votre boîte de réception.",
    confirmEmailSent: "Compte créé ! Vérifiez votre e-mail pour confirmer votre adresse, puis connectez-vous.",
    subscribeTitle: "Abonnez-vous pour accéder au cours",
    subscribeIntro: "Choisissez une formule pour débloquer l'intégralité du cours. Le paiement s'ouvre dans un nouvel onglet ; revenez ensuite ici et cliquez sur « J'ai déjà payé ».",
    planMonthly: "Mensuel",
    planAnnual: "Annuel",
    planLifetime: "À vie (paiement unique)",
    alreadyPaid: "J'ai déjà payé — actualiser mon accès",
    checkingAccess: "Vérification de votre accès…",
    accessNotFound: "Accès pas encore actif. Le paiement peut prendre un instant — réessayez dans quelques secondes.",
    cardLabel: "Carte",
  ...
  ja: {
    ...
    errorEmailNotConfirmed: "ログインの前に、メールで届いたリンクからメールアドレスを確認してください。",
    errorGeneric: "エラーが発生しました。もう一度お試しください。",
    forgotPassword: "パスワードをお忘れですか?",
    resetEmailSent: "リセット用メールを送信しました。受信トレイをご確認ください。",
    confirmEmailSent: "アカウントを作成しました!確認メールからメールアドレスを認証し、ログインしてください。",
    subscribeTitle: "コースを利用するには登録が必要です",
    subscribeIntro: "プランを選ぶとコースの全内容が利用できます。支払い画面は新しいタブで開きます。完了したらこの画面に戻り「支払い済み」を押してください。",
    planMonthly: "月額",
    planAnnual: "年額",
    planLifetime: "買い切り(一括払い)",
    alreadyPaid: "支払い済み — アクセスを更新する",
    checkingAccess: "アクセスを確認しています…",
    accessNotFound: "まだアクセスが有効になっていません。反映に少し時間がかかる場合があります。数秒後にもう一度お試しください。",
    cardLabel: "カード",
